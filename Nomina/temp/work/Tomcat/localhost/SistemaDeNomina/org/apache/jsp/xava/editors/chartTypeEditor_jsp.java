 ...
 * Generated at: 2025-12-11 04:24:43 UTC
...
public final class chartTypeEditor_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("jar:file:/C:/SistemaDeNomina/Nomina/target/SistemaDeNomina/WEB-INF/lib/jstl-1.2.jar!/META-INF/c-1_0.tld", Long.valueOf(1153403082000L));
    _jspx_dependants.put("jar:file:/C:/SistemaDeNomina/Nomina/target/SistemaDeNomina/WEB-INF/lib/jstl-1.2.jar!/META-INF/fmt-1_0.tld", Long.valueOf(1153403082000L));
    _jspx_dependants.put("/WEB-INF/lib/jstl-1.2.jar", Long.valueOf(1763510891701L));
    _jspx_dependants.put("/xava/editors/../imports.jsp", Long.valueOf(1662482618000L));
    _jspx_dependants.put("/WEB-INF/openxava.tld", Long.valueOf(1662482618000L));
  }
...
for (Chart.ChartType type: Chart.ChartType.values()) {
	...
	String cssStyle = (type == chart.getChartType())?"pointer-events: none; cursor: default;":""; // Must be inline, in the CSS class produces an ugly trembling effect
      ...
      try {
        ...
        // /xava/editors/chartTypeEditor.jsp(17,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_xava_005flink_005f0.setAction("Chart.selectType");
        // /xava/editors/chartTypeEditor.jsp(17,0) name = argv type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_xava_005flink_005f0.setArgv("chartType=" + type.name());
        // /xava/editors/chartTypeEditor.jsp(17,0) name = cssClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_xava_005flink_005f0.setCssClass(selected);
        // /xava/editors/chartTypeEditor.jsp(17,0) name = cssStyle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
